...
import { RequestParam } from '../../model/util/util.model';
...
export class RestService {
  ...
  get(url: string, params?: RequestParam[]): Observable<any> {
    if (params === undefined) {
      return this.http
      ...
      params.forEach(element => {
        if (element.param !== '' && element.param !== undefined) {
  ...
  deleteServiceWithId(url: string, key: string, val: number): Observable<any> {
    return this.http
